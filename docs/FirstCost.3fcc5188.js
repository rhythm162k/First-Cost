...
})({"gofy9":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "213b51613fcc5188";
"use strict";
...
},{}],"hoSW4":[function(require,module,exports,__globalThis) {
...
var _transactionViewJs = require("./views/transactionView.js");
...
var _registerViewJs = require("./views/registerView.js");
var _registerViewJsDefault = parcelHelpers.interopDefault(_registerViewJs);
var _filterTransactionJs = require("./views/filterTransaction.js");
var _filterTransactionJsDefault = parcelHelpers.interopDefault(_filterTransactionJs);
...
const readingData = function() {
    ...
    _modelJs.init(accounts);
};
const controlDashboardAndTransaction = function() {
    const userName = _modelJs.state.fullName.trim().split(" ").slice(-1)[0];
    (0, _dashboardViewJsDefault.default).updateBalance(_modelJs.state.balace);
    (0, _dashboardViewJsDefault.default).updateExpense(_modelJs.state.expense);
    (0, _dashboardViewJsDefault.default).updateIncome(_modelJs.state.income);
    (0, _dashboardViewJsDefault.default).updateSavings(_modelJs.state.savings);
    (0, _dashboardViewJsDefault.default).updateUserName(userName[0].toUpperCase() + userName.slice(1).toLowerCase());
    (0, _transactionViewJsDefault.default).render(_modelJs.state.transaction);
};
...
const controlFormData = async function(data) {
    try {
        await _modelJs.userData(data);
        crntTheme();
        controlDashboardAndTransaction();
        controlCharts();
        (0, _loginViewJsDefault.default).logHandler();
    } catch (err) {
        (0, _loginViewJsDefault.default).errorHandler(err.message);
    }
};
const controlRegistration = async function(data) {
    try {
        await _modelJs.newRegistration(data);
        (0, _registerViewJsDefault.default).modalHandler();
    } catch (err) {
        (0, _registerViewJsDefault.default).errorHandler(err.message);
    }
};
const controlNewTransaction = async function(data) {
    _modelJs.newTransaction(data);
    controlDashboardAndTransaction();
    controlCharts();
    (0, _transactionViewJsDefault.default).toggleTransactionForm();
};
const controlDeleteTxn = async function(id) {
    _modelJs.deleteTranx(id);
    controlDashboardAndTransaction();
    controlCharts();
};
const controlFilter = async function(data) {
    filteredTRX = _modelJs.filterTRX(data);
    if (filteredTRX.length === 0) return;
    (0, _transactionViewJsDefault.default).render(filteredTRX);
};
...
const crntTheme = function() {
    ...
    (0, _themeViewJsDefault.default).theme(theme);
};
...
const init = function() {
    readingData();
    (0, _transactionViewJsDefault.default).addTransactionHandler();
    (0, _transactionViewJsDefault.default).formHandler(controlNewTransaction);
    (0, _transactionViewJsDefault.default).deleteTransactionHandler(controlDeleteTxn);
    (0, _filterTransactionJsDefault.default).addFilterBtnHandler();
    (0, _filterTransactionJsDefault.default).formHandler(controlFilter);
    (0, _filterTransactionJsDefault.default).removeFilterHandler(controlRemoveFilter);
    (0, _sidebarViewJsDefault.default).addMenubarHandler();
    (0, _sidebarViewJsDefault.default).addOverlayHandler();
    (0, _sidebarViewJsDefault.default).sideNavHandler();
    (0, _navigationViewJsDefault.default).navigateToHandler(controlNav);
    (0, _loginViewJsDefault.default).formHandler(controlFormData);
    (0, _loginViewJsDefault.default).logoutHandler();
    (0, _registerViewJsDefault.default).formHandler(controlRegistration);
...
},{"./model.js":"1fJ1U","./views/dashboardView.js":"634bo","./views/transactionView.js":"1kj1z","./views/sidebarView.js":"jvshn","./views/navigationView.js":"bunKb","./views/loginView.js":"4abfB","./views/registerView.js":"lptqv","./views/filterTransaction.js":"6XfIt","./views/chartView.js":"4yumb","./views/themeView.js":"lVD6F","./views/deleteAccView.js":"1dt7g","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1fJ1U":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const userData = async function(data) {
    try {
        ...
        if (!crntUser) throw new Error("User Not Found, Please Create an Account ;)");
...
const newRegistration = async function(data) {
    try {
        const found = accounts.find((acc)=>acc.name === data.username);
        if (found) throw new Error("Username already Exists :(");
        if (data.password !== data.confirmPassword) throw new Error("Password didn't match");
        const newAcc = {
...
const deleteTranx = function(id) {
    crntUser.transactions.splice(crntUser.transactions.findIndex((trx)=>trx.id === id), 1);
    localStorage.setItem("accounts", JSON.stringify(accounts));
    setInit();
    updateState(crntUser.transactions);
};
...
const filterTRX = function(data) {
    const filteredTRX = state.transaction.filter((trx)=>{
        const categoryMatch = !data.category || trx.category.toLowerCase().trim().includes(data.category.toLowerCase().trim());
        const dateMatch = !data.date || trx.date === data.date;
        const typeMatch = !data.type || trx.type.toLowerCase().trim() === data.type.toLowerCase().trim();
        return categoryMatch && dateMatch && typeMatch;
    });
    return filteredTRX;
};
const themeControl = function(theme) {
    crntUser.theme = theme;
    localStorage.setItem("accounts", JSON.stringify(accounts));
};
const updateState = function(transactions) {
    state.transaction = transactions;
    state.income += transactions.filter((trans)=>trans.type === "income").map((tran)=>tran.amount).reduce((inc, crnt)=>inc + crnt, 0);
    state.expense += transactions.filter((trans)=>trans.type === "expense").map((tran)=>tran.amount).reduce((inc, crnt)=>inc + crnt, 0);
    state.savings += transactions.filter((trans)=>trans.type === "savings").map((tran)=>tran.amount).reduce((inc, crnt)=>inc + crnt, 0);
...
},{}],"634bo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Dashboard {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1kj1z":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
class TransactionView extends (0, _viewsJsDefault.default) {
    data;
    ...
    addTransactionHandler() {
        this.addTransactionBtn.addEventListener("click", this.toggleTransactionForm.bind(this));
    }
    ...
    render(data) {
        this.data = data;
        this.data.length === 0 ? this.noTransactionState() : this.transactionState();
    ...
    renderMarkup(data) {
      ...
      <article class="transaction">
        <div>
          <h4>${data.category}</h4>
          <small>${data.type} \u{2022} ${data.date}</small>
        </div>
...
},{"./views.js":"hhNBq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hhNBq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Views {
    formHandler(handler) {
    ...
    noTransactionState(placeholder) {
        placeholder ? placeholder.classList.add("hidden") : this.filterBtn.classList.add("hidden");
        document.querySelector(".filter").classList.add("hidden");
        this.emptyState.classList.remove("hidden");
    }
    transactionState(placeholder) {
        placeholder ? placeholder.classList.remove("hidden") : this.filterBtn.classList.remove("hidden");
        this.emptyState.classList.add("hidden");
    }
    errorHandler(msg) {
        const html = `
        <p class="error-msg">
            <span style="color: red">\u{26A0}</span> ${msg}
        </p>
    `;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jvshn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SidebarView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bunKb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class NavigationView {
    _parent = document.querySelectorAll(".navigation");
    navigateToHandler(handler) {
        this._parent.forEach((nav)=>nav.addEventListener("click", function(e) {
                const btn = e.target.closest(".navigate-to");
                if (!btn) return;
                handler(btn);
            }));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4abfB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
class LoginView extends (0, _viewsJsDefault.default) {
...
},{"./views.js":"hhNBq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lptqv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
class RegisterView extends (0, _viewsJsDefault.default) {
...
},{"./views.js":"hhNBq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6XfIt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
class FilterTransaction extends (0, _viewsJsDefault.default) {
    ...
    addFilterBtnHandler() {
        this.addFilterBtn.addEventListener("click", this.toggleFilterForm.bind(this));
    }
    removeFilterHandler(handler) {
        this.removeFilterBtn.addEventListener("click", handler);
    }
}
exports.default = new FilterTransaction();

},{"./views.js":"hhNBq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4yumb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
class ChartView extends (0, _viewsJsDefault.default) {
    ...
    _monthlyChart = null;
    statsState(data) {
        data.length === 0 ? this.chartPlaceHolder.forEach((placeholder)=>this.noTransactionState(placeholder)) : this.chartPlaceHolder.forEach((placeholder)=>this.transactionState(placeholder));
    }
            ...
            this._chartInstance = new (0, _autoDefault.default)(this._expenseChartEl, {
                ...
                options: {
                    ...
                    plugins: {
                        legend: {
                            labels: {
                                color: getComputedStyle(this.body).getPropertyValue("--text").trim()
                            }
                        }
                    }
                }
    ...
    updateColors() {
        const textColor = getComputedStyle(this.body).getPropertyValue("--text").trim();
...
},{"./views.js":"hhNBq","chart.js/auto":"a3bOj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"a3bOj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lVD6F":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const logoLight = new URL(require("48a0de9f5b9a873")).href;
const logoDark = new URL(require("dfb031a7d340c792")).href;
class ThemeView {
    ...
    themeBtnHandler(handler) {
        this._parent.addEventListener("click", ()=>{
            ...
            this._parent.textContent = isDark ? "Toggle Light Mode" : "Toggle Dark Mode";
...
},{"48a0de9f5b9a873":"9faGK","dfb031a7d340c792":"9auwY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9faGK":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.2ffbb861.png") + "?" + Date.now();
...
},{"./views.js":"hhNBq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["gofy9","hoSW4"], "hoSW4", "parcelRequire5b86", {}, "./", "/")
